  ...
  const services = [
    {
      ...
      description: "Sites personalizados com tecnologias modernas, rápidos, responsivos e otimizados para SEO.",
    ...
    },
    {
      ...
      description: "Arte digital e designs impressionantes que capturam a atenção e comunicam a mensagem da sua marca.",
    ...
    },
    {
      ...
      description: "Estratégias de marketing digital para aumentar sua presença online e impulsionar conversões.",
      features: ["Gestão de Redes Sociais", "Criação de Conteúdo", "Análise & Relatórios"],
